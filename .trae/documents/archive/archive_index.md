...
| 文档编号 | 文档名称 | 版本 | 创建日期 | 路径 | 状态 |
|----------|----------|------|----------|------|------|
| DOC-MAIN-001 | 电商独立站项目计划 | v1.0 | 2026-05-31 | [ecommerce_store_plan.md](file:///d:/Atemp/cc/ecommerce-store/.trae/documents/ecommerce_store_plan.md) | ✅ 活跃 |
...
| 文档编号 | 通知标题 | 版本 | 发布日期 | 通知对象 | 路径 | 状态 |
|----------|----------|------|----------|----------|------|------|
| NOTIFY-2026-001 | Phase 2 完成通知 - 商品模块开发完成 | v1.0 | 2026-06-01 | 全体项目成员 | [NOTIFY-2026-001_phase2_complete.md](file:///d:/Atemp/cc/ecommerce-store/.trae/documents/notifications/NOTIFY-2026-001_phase2_complete.md) | ✅ 已发布 |
| NOTIFY-2026-002 | Phase 3 完成通知 - 购物车模块开发完成 | v1.0 | 2026-06-02 | 全体项目成员 | [NOTIFY-2026-002_phase3_complete.md](file:///d:/Atemp/cc/ecommerce-store/.trae/documents/notifications/NOTIFY-2026-002_phase3_complete.md) | ✅ 已发布 |
...
| 类型代码 | 类型名称 | 说明 | 存储目录 |
|----------|----------|------|----------|
| MAIN | 项目主文档 | 项目计划、PRD、技术架构等 | `/` |
| PROG | 进度汇报 | 各阶段进度汇报、周报、月报 | `phase_reports/` |
| NOTIFY | 通知公告 | 项目通知、里程碑公告 | `notifications/` |
| ARC | 存档文档 | 历史版本、过期文档 | `archive/` |

### 3.2 检索标签体系

| 标签类别 | 标签值 | 说明 |
|----------|--------|------|
| **阶段标签** | `Phase-0` `Phase-1` `Phase-2` `Phase-3` `Phase-4` `Phase-5` `Phase-6` | 对应项目开发阶段 |
| **模块标签** | `商品模块` `购物车模块` `用户模块` `订单支付` `基础架构` | 功能模块 |
| **文档类型** | `项目汇报` `进度跟踪` `技术文档` `通知公告` | 文档性质 |
| **优先级** | `P0` `P1` `P2` | 重要程度 |
...
**示例**:
- `20260601_project_progress_report_v1.0.md`
- `20260615_phase3_complete_report_v1.2.md`
...
- 小版本更新（v1.0 → v1.1）：修正错误、补充内容
- 大版本更新（v1.0 → v2.0）：结构调整、重大变更
- 历史版本：自动归档到 `archive/history/` 目录
...
```bash
# 按文件名日期排序
ls -la .trae/documents/phase_reports/ | sort
```
